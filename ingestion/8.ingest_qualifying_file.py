...
# MAGIC %md
# MAGIC ### Ingest qualifying files (json)
...
# MAGIC %md
# MAGIC ##### Step 1 - Read the multi-line json files using the spark dataframe reader API
...
# display(spark.read.parquet("/mnt/noahformula1dl/processed/qualifying"))
